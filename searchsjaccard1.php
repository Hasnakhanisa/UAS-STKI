...
$query="delete from katakunci";
$result=mysqli_query ($koneksi,$query);

$query="alter table katakunci drop id";
$result=mysqli_query ($koneksi,$query);

$query="alter table katakunci add id int not null auto_increment primary key first";
$result=mysqli_query ($koneksi,$query);
